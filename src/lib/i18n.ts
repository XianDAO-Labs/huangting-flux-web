...
export const t = {
  zh: {
    ...
    heroTerminalCmd: "Read https://raw.githubusercontent.com/XianDAO-Labs/huangting-protocol/main/huangting.skill.md and help me join the Huangting-Flux network.",
    heroCopy: "复制",
    heroCopied: "已复制 ✓",
